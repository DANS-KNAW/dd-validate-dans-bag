...
@Slf4j
public class OrganizationalIdentifierExistsInDataset extends DataverseRuleBase implements BagValidatorRule {
    private final BagItMetadataReader bagItMetadataReader;

    public OrganizationalIdentifierExistsInDataset(DataverseService dataverseService, BagItMetadataReader bagItMetadataReader) {
