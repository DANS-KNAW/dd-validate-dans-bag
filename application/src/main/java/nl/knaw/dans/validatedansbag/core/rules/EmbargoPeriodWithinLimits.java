...
@Slf4j
public class EmbargoPeriodWithinLimits extends DataverseRuleBase implements BagValidatorRule {
    private final XmlReader xmlReader;

    public EmbargoPeriodWithinLimits(DataverseService dataverseService, XmlReader xmlReader) {
