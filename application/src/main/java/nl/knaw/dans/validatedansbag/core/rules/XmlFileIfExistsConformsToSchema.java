...
@Slf4j
public class XmlFileIfExistsConformsToSchema extends XmlFileConformsToSchema {
    private final FileService fileService;

    public XmlFileIfExistsConformsToSchema(Path file, XmlReader reader, String schema, XmlSchemaValidator validator, FileService fileService) {
